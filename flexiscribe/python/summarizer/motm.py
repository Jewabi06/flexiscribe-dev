...
6. The "speaker" field MUST ALWAYS be an empty string "". Never fill it in.
7. For "prepared_by", use the name of the person who prepared or recorded the minutes as stated in the transcript. If unclear, write "To be determined".
8. The "meeting_title" should be derived from the main topic or purpose of the meeting as indicated in the transcript.
9. The "date" and "time" should reflect when the meeting took place. If not stated, write "Not specified".
10. The "next_meeting" object must be a TOP-LEVEL field in the JSON, at the same level as "meeting_title" and "agendas". Do NOT nest it inside any agenda.
...
{{
  ...
  "next_meeting": {{
    "date": "Next meeting date or To be announced",
    "time": "Next meeting time or To be announced"
  }},
