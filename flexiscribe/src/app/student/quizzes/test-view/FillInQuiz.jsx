...
export default function FillInQuiz({ quiz, questions }) {
  ...
  const normalizeAnswer = (text) => text.toLowerCase().trim().replace(/[.,!?;:]/g, '');
  ...
  const renderQuestion = () => {
    const parts = currentQuestion.question.split(/\[blank\]/i);
    return (
      ...
      <main className="main-content flex flex-col justify-between min-h-screen">
        ...
        <div className="quiz-content-main">
          <div className="quiz-header-section">
            <div className="quiz-type-dropdown"><span className="quiz-type-icon">✏️</span><span className="quiz-type-text">Fill-in</span></div>
